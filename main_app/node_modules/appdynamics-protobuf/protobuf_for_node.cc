...
namespace protobuf_for_node {
  ...
  void SetPrivate(Local<Object> object,
                  Local<String> key,
                  Local<Value>  value) {
    if (value.IsEmpty())
      return;
    ...
    public:
      ...
      Type(Schema* schema, const Descriptor* descriptor, Local<Object> self)
        ...
        Local<Function> constructor =
          Script::Compile(Nan::New<String>(from.str().c_str()).ToLocalChecked())->Run().As<Function>();
        ...
        self->SetInternalField(3, Script::Compile(Nan::New<String>(to.str().c_str()).ToLocalChecked())->Run());
      ...
      static Local<Value> ToJs(const Message& instance,
        ...
        case FieldDescriptor::CPPTYPE_STRING: {
          ...
          if (field->type() == FieldDescriptor::TYPE_BYTES) {
            return Nan::CopyBuffer(const_cast<char *>(value.data()),
...
#undef SET
      ...
      static NAN_METHOD(ToString) {
        Type *type = Unwrap<Type>(info.This());
        info.GetReturnValue().Set(Nan::New<String>(type->descriptor_->full_name().c_str()).ToLocalChecked());
      }
    };
