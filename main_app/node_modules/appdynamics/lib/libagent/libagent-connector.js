...
LibagentConnector.prototype.stopBusinessTransaction = function(transaction) {
  ...
  if (transaction.error) {
    ...
    self.libagent.addErrorToTransaction(transaction.btGuid, name, message, transaction.statusCode);
  }
...
LibagentConnector.prototype.initializeTimers = function() {
  ...
  self.processAndSendSnapshotsTimerId = new MessageSender(self.agent, 0, 10 * 1000, function() {
