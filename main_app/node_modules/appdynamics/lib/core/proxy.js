...
Proxy.prototype.before = function(obj, meths, hook, isCallbackHook, copyAllProps) {
  var self = this;
...
Proxy.prototype.after = function(obj, meths, hook, copyAllProps) {
  var self = this;
...
Proxy.prototype.around = function(obj, meths, hookBefore, hookAfter, copyAllProps) {
  var self = this;
  ...
  meths.forEach(function(meth) {
    ...
    obj[meth] = function() {
      ...
      var ret = orig.apply(this, arguments);
      var promiseRet = self.promise(ret, hookAfter, this, arguments, locals);
      if (promiseRet)
        return promiseRet;
